...
import de.sciss.mellite.gui.{FolderEditorView, MarkdownRenderFrame, MessageException, ObjListView, Shapes}
import de.sciss.mellite.{GUI, Mellite, ObjView, executionContext}
