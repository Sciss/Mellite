...
lazy val commonVersion              = "2.45.9-SNAPSHOT"
lazy val mimaCommonVersion          = "2.45.0"
lazy val appVersion                 = "2.49.2-SNAPSHOT"
...
lazy val deps = new {
  val common = new {
    ...
    val serial              = "1.1.2"
    val sonogram            = "1.11.2"
    val soundProcesses      = "3.35.10-SNAPSHOT"
    val span                = "1.4.3"
    val swingPlus           = "0.4.2"
  }
  val app = new {
