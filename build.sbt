...
lazy val deps = new {
  val main = new {
    ...
    val appDirs             = "1.0.3"
    val audioFile           = "1.5.3"
    val audioWidgets        = "1.14.2-SNAPSHOT"
    val desktop             = "0.10.4-SNAPSHOT"
    val dotterweide         = "0.2.0-SNAPSHOT"
    val equal               = "0.1.4"
    val fileCache           = "0.5.1"
    val fileUtil            = "1.1.3"
    val fingerTree          = "1.5.4"
    val freesound           = "1.18.0-SNAPSHOT"
    val fscape              = "2.26.0-SNAPSHOT"
    ...
    val topology            = "1.1.2"
    val webLaF              = "2.1.5"
    val wolkenpumpe         = "2.33.0-SNAPSHOT"
  }
}
