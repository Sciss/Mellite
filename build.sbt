...
lazy val commonVersion              = "2.45.0-SNAPSHOT"
lazy val mimaCommonVersion          = "2.45.0"
lazy val appVersion                 = "2.45.0-SNAPSHOT"
lazy val mimaAppVersion             = "2.45.0"
...
lazy val deps = new {
  ...
  val app = new {
    ...
    val freesound           = "1.24.0"
    val fscape              = "2.35.0-SNAPSHOT"
    val interpreterPane     = "1.10.1"
    val jline               = "2.14.6"
    val jump3r              = "1.0.5"
    val kollFlitz           = "0.2.3"
    val negatum             = "0.13.0"
    val patterns            = "0.19.0-SNAPSHOT"
    val pdflitz             = "1.4.1"
    val pegDown             = "1.6.0"
    val playJSON            = "0.4.0"
//    val plexMono            = "4.0.2"   // directly included
    ...
    // val webLaF              = "2.2.1"
    val webLaF              = "1.2.11"
    val wolkenpumpe         = "2.40.0-SNAPSHOT"
  }
}
...
lazy val commonSettings = Seq(
  ...
  scalaVersion       := "2.13.1",
  crossScalaVersions := Seq("2.13.1", "2.12.11"),  // N.B. nsc API has breakage in minor versions (2.13.0 Dotterweide fails on 2.13.1)
  scalacOptions ++= {
    val xs = Seq(
